...
- **"사용 가능한 도메인 검색해줘"** — 최대 100개 도메인을 한 번에 가격과 함께 검색
- **"새 도메인 등록해줘"** — 단일 또는 대량 도메인 등록
- **"도메인 DNS 레코드 수정해줘"** — A, AAAA, CNAME, MX, TXT, SRV 레코드 설정
- **"도메인을 Dynadot으로 이전해줘"** — 인증 코드를 사용한 도메인 전입
- **"이메일 포워딩 설정해줘"** — 이메일 포워딩 또는 MX 레코드 설정
- **"도메인 갱신해줘"** — 만료 전 갱신
- **"도메인 잠금/해제해줘"** — 이전 잠금 상태 관리
- **"도메인 WHOIS 정보 확인해줘"** — WHOIS 프라이버시 설정 관리
